          ...
          <div className="lg:col-span-3 space-y-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-blue-600 p-8 text-white">
                  ...
                  <p className="text-blue-100 mb-6">
                    File ITR-3 for individuals having income from business or
                    profession.
                  </p>
            ...
            <Card className="p-8">
              ...
              <p className="text-gray-700 mb-4">
                ITR-3 is for individuals and HUFs having income from business or
                profession.
              </p>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li>Individuals with business income</li>
                <li>Professionals like doctors, lawyers, consultants</li>
                <li>Partnership firm partners</li>
                <li>
                  Those with presumptive business income under section 44AD
                </li>
              </ul>
            </Card>
          </div>
