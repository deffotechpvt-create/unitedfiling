...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Register your partnership firm with complete legal documentation",
      price: "₹3,999",
      popular: false,
      link: "/partnership"
    },
    ...
    },
    {
      ...
      description: "Get your digital signature certificate for online filing",
      price: "₹1,499",
      popular: false,
    ...
    },
    {
      ...
      description: "Register your trust with complete legal formalities",
      price: "₹4,999",
      popular: false,
