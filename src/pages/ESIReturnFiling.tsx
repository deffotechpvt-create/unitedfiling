          ...
          <div className="lg:col-span-3 space-y-8">
            <Card className="overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-blue-600 p-8 text-white">
                  <h1 className="text-3xl font-bold mb-4">ESI Return Filing</h1>
                  <p className="text-blue-100 mb-6">
                    File Employee State Insurance returns and maintain
            ...
            <Card className="p-8">
              ...
              <p className="text-gray-700 mb-4">
                Employers must file monthly ESI returns and remit contributions
                to ESIC.
              </p>
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                <li>Monthly return filing by 15th</li>
                <li>Employee and employer contributions</li>
                <li>Half-yearly return filing</li>
                <li>Annual return submission</li>
...
export default ESIReturnFiling;
