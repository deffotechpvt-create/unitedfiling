    ...
    <Card>
      ...
      <CardContent className="space-y-6 text-gray-700 leading-relaxed">
        ...
        <p className="font-semibold text-green-600">
          Get expert help from United Filings for seamless professional tax payment based
        ...
        <div>
          <h3 className="text-xl font-bold pt-4 mb-2">
            Seamless Professional Tax Registration Services with United Filings
          </h3>
          <p>
            United Filings can assist you in simplifying the process of obtaining a
            Professional Tax Registration Certificate in India. Here's how our
            services can benefit you:
          </p>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>
              Expert Guidance: United Filings provides expert guidance on the Tax
            ...
            <li>
              Application Submission: United Filings will handle submitting your Tax
              Registration application to the relevant authorities on your
              behalf. This ensures accuracy and compliance with all legal
              requirements.
            </li>
            <li>
              Timely Processing: With United Filings' professional handling, you can
            ...
            <li>
              Customized Support: United Filings understands that each business and
            ...
            <li>
              ...
              and regulations is crucial. United Filings pays attention to the details,
            ...
            <li>
              ...
              the registration process, United Filings' customer support team is readily
        ...
        <p className="font-semibold text-green-600">
          File Your Professional Taxes Efficiently with United Filings!
        </p>
      </CardContent>
    </Card>
  );
